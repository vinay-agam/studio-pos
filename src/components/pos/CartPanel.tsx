...
export function CartPanel({ isInSheet = false, onCartClose }: CartPanelProps) {
    const {
    ...
    return (
        <div className="flex flex-col h-full border-l bg-card">
            {items.length === 0 ? (
                <div className="flex-1 flex flex-col items-center justify-center p-8 text-muted-foreground bg-muted/10 relative">
            ...
            <CheckoutDialog total={total} open={checkoutOpen} onOpenChange={setCheckoutOpen} onComplete={onCartClose} />
        </div>
    );
}
